    ...
    <header class="text-gray-400 bg-gray-900 body-font">
      <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
          <Link href={'/'} class="mr-5 hover:text-white cursor-pointer">Home</Link>
          <Link href={'#course'} class="mr-5 hover:text-white cursor-pointer">Course</Link>
          <Link href={'/'} class="mr-5 hover:text-white cursor-pointer">About Us</Link>
          <Link href={'/'} class="mr-5 hover:text-white cursor-pointer">Contact Us</Link>
        </nav>
